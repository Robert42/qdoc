...
enum { Tok_Eoi, Tok_Ampersand, Tok_Aster, Tok_Caret, Tok_LeftParen,
       ...
       Tok_void, Tok_volatile, Tok_int64,
       Tok_delete, Tok_final, Tok_override,
       ...
       Tok_Q_DECLARE_FLAGS, Tok_Q_DECLARE_OPERATORS_FOR_FLAGS, Tok_Q_SIGNALS, Tok_Q_SLOTS, Tok_QT_COMPAT,
